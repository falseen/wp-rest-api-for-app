...
add_action( 'rest_api_init', function () {
    register_rest_route( 'watch-life-net/v1', 'weixin/updataUserInfo', array(
      'methods' => 'POST',
      'callback' => 'updataUserInfo'
    ) );
  } );


function updataUserInfo($request){
    global $wpdb;
    $userdata = array(
    ...
    {
        $result["code"]="success";
        $result["message"]= "update userInfo success  ";
        $result["status"]="200";
